  ...
  return (
    <header className="md:sticky top-[1%] p-5 flex items-center justify-between max-w-7xl mx-auto z-50 md:w-screen ">
      ...
      >
        {theme === "dark" ? (
          <a
            href="https://amplify-venu20-dev-131644-deployment.s3.us-east-1.amazonaws.com/Patrick+Poole+Dark+Resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://amplify-venu20-dev-131644-deployment.s3.us-east-1.amazonaws.com/Patrick+Poole+Resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="w-auto flex md:mr-4 group"
          >
