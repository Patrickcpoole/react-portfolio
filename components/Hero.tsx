  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center text-center md:space-y-8 overflow-hidden w-full">
      ...
      <div className="z-20 relative">
        ...
        <div className="grid grid-rows-3 grid-cols-1 md:flex md:flex-wrap md:justify-center md:items-center md:mt-5 mt-24 w-full relative">
          <Link href="#about">
            <button className="row-start-1 mx-6 border-[#169137]/40 dark:border-[#169137]/40 dark:bg-transparent bg-[#169137]/40 px-6 py-3 border z-50 bg-white rounded-full uppercase text-xs tracking-widest transition-all dark:hover:border-[#169137]/40 hover:border-[#169137] hover:text-[#FFF] dark:hover:bg-[#169137]/40 hover:bg-[#169137] mt-2 md:mt-0">
              About
            </button>
          </Link>
          <div>
            <Link href="#experience">
              <button className="row-start-2 md:mx-6  border-[#169137]/40 dark:border-[#169137]/40 dark:bg-transparent bg-[#169137]/40 px-6 py-3 border z-50 bg-white rounded-full uppercase text-xs tracking-widest transition-all dark:hover:border-[#169137]/40 hover:border-[#169137] hover:text-[#FFF] dark:hover:bg-[#169137]/40 hover:bg-[#169137] mt-2 md:mt-0">
                Experience
              </button>
            </Link>
            <Link href="#projects">
              <button className="row-start-2 mx-6 border-[#169137]/40 dark:border-[#169137]/40 dark:bg-transparent bg-[#169137]/40 px-6 py-3 border z-50 bg-white rounded-full uppercase text-xs tracking-widest transition-all dark:hover:border-[#169137]/40 hover:border-[#169137] hover:text-[#FFF] dark:hover:bg-[#169137]/40 hover:bg-[#169137] mt-2 md:mt-0">
                Projects
              </button>
            </Link>
          </div>
          <Link href="#skills">
            <button className="row-start-3 mx-6 border-[#169137]/40 dark:border-[#169137]/40 dark:bg-transparent bg-[#169137]/40 px-6 py-3 border z-50 bg-white rounded-full uppercase text-xs tracking-widest transition-all dark:hover:border-[#169137]/40 hover:border-[#169137] hover:text-[#FFF] dark:hover:bg-[#169137]/40 hover:bg-[#169137] mt-2 md:mt-0">
              Skills
            </button>
          </Link>
        </div>
