    ...
    return (
        ...
        >
            ...
            <div
                ...
                className='flex flex-col w-full  items-center md:relative md:h-screen  md:flex-row md:w-[95%] md:flex md:snap-x md:snap-mandatory md:overflow-y-hidden md:pb-5 md:hide-scrollbar'
            >
