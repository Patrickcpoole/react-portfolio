...
function Projects({ projects }: Props) {
    ...
    return (
        <div
            ref={projectRef}
            className='relative min-h-screen w-screen flex overflow-x-hidden flex-col text-left max-w-full justify-start mx-auto items-center z-0 overflow-y-scroll my-20'
        >
